...
/*
struct sock *
netlink_kernel_create(int unit, uint32_t groups,
...
/*
struct sock *
netlink_kernel_create(struct net *net, int unit, uint32_t groups,
...
int
mnl_broadcast(struct sk_buff *skb, uint32_t group)
{
    if (G.sk) {
...
int
mnl_unicast(struct sk_buff *skb, uint32_t pid)
{
    if (G.sk) {
