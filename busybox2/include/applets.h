...
#if 1 /* BIGAP */
IF_DOG(APPLET(dog, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
#if 1 /* BIGAP */
IF_OTP(APPLET(otp, _BB_DIR_BIN, _BB_SUID_DROP))
#endif
...
#if 1 /* BIGAP */
IF_TTYUSB0(APPLET(ttyUSB0, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_TTYUSB1(APPLET(ttyUSB1, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_TTYUSB2(APPLET(ttyUSB2, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_TTYUSB3(APPLET(ttyUSB3, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
#endif
