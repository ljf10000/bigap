...
#define smc_trivial_usage       "\n\n"
#define smc_full_usage          "\n\n"

#define smd_trivial_usage       "\n\n"
#define smd_full_usage          "\n\n"

#define sys_trivial_usage       "\n\n"
#define sys_full_usage          "\n\n"

#define sysmount_trivial_usage      "\n\n"
#define sysmount_full_usage         "\n\n"
...
#define sysumount_trivial_usage     "\n\n"
#define sysumount_full_usage        "\n\n"

#define sysupgrade_trivial_usage    "\n\n"
#define sysupgrade_full_usage       "\n\n"

#define sysusbupgrade_trivial_usage "\n\n"
#define sysusbupgrade_full_usage    "\n\n"

#define tmc_trivial_usage       "\n\n"
#define tmc_full_usage          "\n\n"
...
#define udhcpc_trivial_usage \
       "[-Cfbnqtvo] [-c CID] [-V VCLS] [-D DV] [-H HOSTNAME] [-i INTERFACE]\n" \
       "	[-p pidfile] [-r IP] [-s script] [-O dhcp-option]..." IF_FEATURE_UDHCP_PORT(" [-P N]")
#define udhcpc_full_usage "\n\n" \
	IF_LONG_OPTS( \
       "	-V,--vendorclass=CLASSID	Vendor class identifier" \
     "\n	-D,--dhcpd-vendor=CLASSID	DHCP Server Vendor class identifier" \
