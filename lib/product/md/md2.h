...
#define PRODUCT_MODEL                   PRODUCT_Vendor "-md2" /* fixme */
#endif

#ifndef PRODUCT_VERSION
#define PRODUCT_VERSION                 PRODUCT_Vendor "-md2" /* fixme */
#endif

#ifndef PRODUCT_PCBA_MODEL
#define PRODUCT_PCBA_MODEL              PRODUCT_Vendor "-md2" /* fixme */
#endif

#ifndef PRODUCT_PCBA_VERSION
#define PRODUCT_PCBA_VERSION            PRODUCT_Vendor "-md2" /* fixme */
#endif
