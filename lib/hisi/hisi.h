...
#define __hisi_class_module_method_debug(_class, _module, _method, _err)    do{ \
    if (_err) {                        \
...
#define __hisi_class_module_call_0(_class, _module, _method)    ({  \
    ...
    __hisi_class_module_method_debug(_class, _module, _method, __hisi_class_module_call_0_err); \
    __hisi_class_module_call_0_err;                            \
})  /* end */
...
#define __hisi_class_module_call_x(_class, _module, _method, _arg1, _args...) ({  \
    ...
    __hisi_class_module_method_debug(_class, _module, _method, __hisi_class_module_call_x_err); \
    __hisi_class_module_call_x_err;                                        \
})  /* end */
/******************************************************************************/
...
#define __hisi_module_method_debug(_module, _method, _err)    do{ \
    if (_err) {                        \
...
#define __hisi_module_call_0(_module, _method)    ({  \
    ...
    __hisi_module_method_debug(_module, _method, __hisi_module_call_0_err); \
    __hisi_module_call_0_err;                            \
})  /* end */
...
#define __hisi_module_call_x(_module, _method, _arg1, _args...) ({  \
    ...
    __hisi_module_method_debug(_module, _method, __hisi_module_call_x_err); \
    __hisi_module_call_x_err;                                        \
})  /* end */
/******************************************************************************/
