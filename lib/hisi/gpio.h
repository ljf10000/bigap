...
#define GPIO_NUMBER_MON_VCC         GPIO_NUMBER(0, 3)   // 0*8 + 3 = 3
#define GPIO_NUMBER_SHUT_FORCE		GPIO_NUMBER(5, 2)   // 5*8 + 2 = 42
#define GPIO_NUMBER_MON_ACC			GPIO_NUMBER(5, 5)   // 5*8 + 2 = 45
