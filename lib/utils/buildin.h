...
#define BUILD_BUG_ON_ZERO(_condition)       (sizeof(struct __buildin_bug_on_zero { int:-!!(_condition); }))
#endif

#ifndef BUILD_BUG_ON_NULL
#define BUILD_BUG_ON_NULL(_condition)       ((void *)sizeof(struct __buildin_bug_on_null { int:-!!(_condition); }))
#endif
