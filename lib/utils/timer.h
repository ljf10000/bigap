...
tm_fd_read(int fd)
{
    ...
    os_println("__ak_debug_timeout=0x%x ____ak_debug_timeout=0x%x LOG_DEBUGLEVEL=0x%x", __ak_debug_timeout, ____ak_debug_timeout, LOG_DEBUGLEVEL(__ak_debug_timeout));
