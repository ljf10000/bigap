...
tm_fd_read(int fd)
{
    ...
    os_println("__ak_debug_timeout=0x%x ____ak_debug_timeout=0x%x JLOG_DEBUGLEVEL=0x%x", __ak_debug_timeout, ____ak_debug_timeout, JLOG_DEBUGLEVEL(__ak_debug_timeout));
