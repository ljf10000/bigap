...
* use for others
*/
#define vdebug_ok(_fmt, _args)          __jvdlogger(dvlogger, __ak_debug_ok, _fmt, _args)
#define vdebug_bug(_fmt, _args)         __jvdlogger(dvlogger, __ak_debug_bug, _fmt, _args)
#define vdebug_error(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_error, _fmt, _args)
#define vdebug_trace(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_trace, _fmt, _args)
#define vdebug_init(_fmt, _args)        __jvdlogger(dvlogger, __ak_debug_init, _fmt, _args)
#define vdebug_config(_fmt, _args)      __jvdlogger(dvlogger, __ak_debug_config, _fmt, _args)
#define vdebug_lib(_fmt, _args)         __jvdlogger(dvlogger, __ak_debug_lib, _fmt, _args)
#define vdebug_io(_fmt, _args)          __jvdlogger(dvlogger, __ak_debug_io, _fmt, _args)
#define vdebug_timer(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_timer, _fmt, _args)
#define vdebug_timeout(_fmt, _args)     __jvdlogger(dvlogger, __ak_debug_timeout, _fmt, _args)
#define vdebug_aging(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_aging, _fmt, _args)
#define vdebug_event(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_event, _fmt, _args)
#define vdebug_entry(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_entry, _fmt, _args)
#define vdebug_packet(_fmt, _args)      __jvdlogger(dvlogger, __ak_debug_packet, _fmt, _args)
#define vdebug_flow(_fmt, _args)        __jvdlogger(dvlogger, __ak_debug_flow, _fmt, _args)
#define vdebug_signal(_fmt, _args)      __jvdlogger(dvlogger, __ak_debug_signal, _fmt, _args)
#define vdebug_shell(_fmt, _args)       __jvdlogger(dvlogger, __ak_debug_shell, _fmt, _args)
#define vdebug_st(_fmt, _args)          __jvdlogger(dvlogger, __ak_debug_st, _fmt, _args)
#define vdebug_gc(_fmt, _args)          __jvdlogger(dvlogger, __ak_debug_gc, _fmt, _args)
#define vdebug_js(_fmt, _args)          __jvdlogger(dvlogger, __ak_debug_js, _fmt, _args)
#define vdebug_blob(_fmt, _args)        __jvdlogger(dvlogger, __ak_debug_blob, _fmt, _args)
#define vdebug_json(_fmt, _args)        __jvdlogger(dvlogger, __ak_debug_json, _fmt, _args)
#define vdebug_test(_fmt, _args)        __jvdlogger(dvlogger, __ak_debug_test, _fmt, _args)

#define debug_ok(_fmt, _args...)        __jdlogger(dlogger, __ak_debug_ok, _fmt, ##_args)
#define debug_bug(_fmt, _args...)       __jdlogger(dlogger, __ak_debug_bug, _fmt, ##_args)
#define debug_error(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_error, _fmt, ##_args)
#define debug_trace(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_trace, _fmt, ##_args)
#define debug_init(_fmt, _args...)      __jdlogger(dlogger, __ak_debug_init, _fmt, ##_args)
#define debug_config(_fmt, _args...)    __jdlogger(dlogger, __ak_debug_config, _fmt, ##_args)
#define debug_lib(_fmt, _args...)       __jdlogger(dlogger, __ak_debug_lib, _fmt, ##_args)
#define debug_io(_fmt, _args...)        __jdlogger(dlogger, __ak_debug_io, _fmt, ##_args)
#define debug_timer(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_timer, _fmt, ##_args)
#define debug_timeout(_fmt, _args...)   __jdlogger(dlogger, __ak_debug_timeout, _fmt, ##_args)
#define debug_aging(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_aging, _fmt, ##_args)
#define debug_event(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_event, _fmt, ##_args)
#define debug_entry(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_entry, _fmt, ##_args)
#define debug_packet(_fmt, _args...)    __jdlogger(dlogger, __ak_debug_packet, _fmt, ##_args)
#define debug_flow(_fmt, _args...)      __jdlogger(dlogger, __ak_debug_flow, _fmt, ##_args)
#define debug_signal(_fmt, _args...)    __jdlogger(dlogger, __ak_debug_signal, _fmt, ##_args)
#define debug_shell(_fmt, _args...)     __jdlogger(dlogger, __ak_debug_shell, _fmt, ##_args)
#define debug_st(_fmt, _args...)        __jdlogger(dlogger, __ak_debug_st, _fmt, ##_args)
#define debug_gc(_fmt, _args...)        __jdlogger(dlogger, __ak_debug_gc, _fmt, ##_args)
#define debug_js(_fmt, _args...)        __jdlogger(dlogger, __ak_debug_js, _fmt, ##_args)
#define debug_blob(_fmt, _args...)      __jdlogger(dlogger, __ak_debug_blob, _fmt, ##_args)
#define debug_json(_fmt, _args...)      __jdlogger(dlogger, __ak_debug_json, _fmt, ##_args)
#define debug_test(_fmt, _args...)      __jdlogger(dlogger, __ak_debug_test, _fmt, ##_args)
...
* use for logger inline function
*/
#define __vdebug_ok(_fmt, _args)        jvdlogger(__ak_debug_ok, _fmt, _args)
#define __vdebug_bug(_fmt, _args)       jvdlogger(__ak_debug_bug, _fmt, _args)
#define __vdebug_error(_fmt, _args)     jvdlogger(__ak_debug_error, _fmt, _args)
#define __vdebug_trace(_fmt, _args)     jvdlogger(__ak_debug_trace, _fmt, _args)
#define __vdebug_init(_fmt, _args)      jvdlogger(__ak_debug_init, _fmt, _args)
#define __vdebug_config(_fmt, _args)    jvdlogger(__ak_debug_config, _fmt, _args)
#define __vdebug_lib(_fmt, _args)       jvdlogger(__ak_debug_lib, _fmt, _args)
#define __vdebug_io(_fmt, _args)        jvdlogger(__ak_debug_io, _fmt, _args)
#define __vdebug_timer(_fmt, _args)     jvdlogger(__ak_debug_timer, _fmt, _args)
#define __vdebug_timeout(_fmt, _args)   jvdlogger(__ak_debug_timeout, _fmt, _args)
#define __vdebug_aging(_fmt, _args)     jvdlogger(__ak_debug_aging, _fmt, _args)
#define __vdebug_event(_fmt, _args)     jvdlogger(__ak_debug_event, _fmt, _args)
#define __vdebug_entry(_fmt, _args)     jvdlogger(__ak_debug_entry, _fmt, _args)
#define __vdebug_packet(_fmt, _args)    jvdlogger(__ak_debug_packet, _fmt, _args)
#define __vdebug_flow(_fmt, _args)      jvdlogger(__ak_debug_flow, _fmt, _args)
#define __vdebug_signal(_fmt, _args)    jvdlogger(__ak_debug_signal, _fmt, _args)
#define __vdebug_shell(_fmt, _args)     jvdlogger(__ak_debug_shell, _fmt, _args)
#define __vdebug_st(_fmt, _args)        jvdlogger(__ak_debug_st, _fmt, _args)
#define __vdebug_gc(_fmt, _args)        jvdlogger(__ak_debug_gc, _fmt, _args)
#define __vdebug_js(_fmt, _args)        jvdlogger(__ak_debug_js, _fmt, _args)
#define __vdebug_blob(_fmt, _args)      jvdlogger(__ak_debug_blob, _fmt, _args)
#define __vdebug_json(_fmt, _args)      jvdlogger(__ak_debug_json, _fmt, _args)
#define __vdebug_test(_fmt, _args)      jvdlogger(__ak_debug_test, _fmt, _args)

#define __debug_ok(_fmt, _args...)      jdlogger(__ak_debug_ok, _fmt, ##_args)
#define __debug_bug(_fmt, _args...)     jdlogger(__ak_debug_bug, _fmt, ##_args)
#define __debug_error(_fmt, _args...)   jdlogger(__ak_debug_error, _fmt, ##_args)
#define __debug_trace(_fmt, _args...)   jdlogger(__ak_debug_trace, _fmt, ##_args)
#define __debug_init(_fmt, _args...)    jdlogger(__ak_debug_init, _fmt, ##_args)
#define __debug_config(_fmt, _args...)  jdlogger(__ak_debug_config, _fmt, ##_args)
#define __debug_lib(_fmt, _args...)     jdlogger(__ak_debug_lib, _fmt, ##_args)
#define __debug_io(_fmt, _args...)      jdlogger(__ak_debug_io, _fmt, ##_args)
#define __debug_timer(_fmt, _args...)   jdlogger(__ak_debug_timer, _fmt, ##_args)
#define __debug_timeout(_fmt, _args...) jdlogger(__ak_debug_timeout, _fmt, ##_args)
#define __debug_aging(_fmt, _args...)   jdlogger(__ak_debug_aging, _fmt, ##_args)
#define __debug_event(_fmt, _args...)   jdlogger(__ak_debug_event, _fmt, ##_args)
#define __debug_entry(_fmt, _args...)   jdlogger(__ak_debug_entry, _fmt, ##_args)
#define __debug_packet(_fmt, _args...)  jdlogger(__ak_debug_packet, _fmt, ##_args)
#define __debug_flow(_fmt, _args...)    jdlogger(__ak_debug_flow, _fmt, ##_args)
#define __debug_signal(_fmt, _args...)  jdlogger(__ak_debug_signal, _fmt, ##_args)
#define __debug_shell(_fmt, _args...)   jdlogger(__ak_debug_shell, _fmt, ##_args)
#define __debug_st(_fmt, _args...)      jdlogger(__ak_debug_st, _fmt, ##_args)
#define __debug_gc(_fmt, _args...)      jdlogger(__ak_debug_gc, _fmt, ##_args)
#define __debug_js(_fmt, _args...)      jdlogger(__ak_debug_js, _fmt, ##_args)
#define __debug_blob(_fmt, _args...)    jdlogger(__ak_debug_blob, _fmt, ##_args)
#define __debug_json(_fmt, _args...)    jdlogger(__ak_debug_json, _fmt, ##_args)
#define __debug_test(_fmt, _args...)    jdlogger(__ak_debug_test, _fmt, ##_args)
