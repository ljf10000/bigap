...
#define __vdebug_crypt(_fmt, _args)     jvdlogger(jlog_vprintf, __ak_debug_crypt, _fmt, _args)
...
#define __debug_crypt(_fmt, _args...)   jdlogger(jlog_printf, __ak_debug_crypt, _fmt, ##_args)
...
#define vdebug_crypt(_fmt, _args)       jvdlogger(dvlogger, __ak_debug_crypt, _fmt, _args)
...
#define debug_crypt(_fmt, _args...)     jdlogger(dlogger, __ak_debug_crypt, _fmt, ##_args)
