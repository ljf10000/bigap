...
#define __vdebug_lib(_fmt, _args)       jvdlogger(jlog_vprintf, __ak_debug_lib, _fmt, _args)
...
#define __vdebug_st(_fmt, _args)        jvdlogger(jlog_vprintf, __ak_debug_st, _fmt, _args)
...
#define __debug_lib(_fmt, _args...)     jdlogger(jlog_printf, __ak_debug_lib, _fmt, ##_args)
...
#define __debug_st(_fmt, _args...)      jdlogger(jlog_printf, __ak_debug_st, _fmt, ##_args)
...
#define vdebug_lib(_fmt, _args)         jvdlogger(dvlogger, __ak_debug_lib, _fmt, _args)
...
#define vdebug_st(_fmt, _args)          jvdlogger(dvlogger, __ak_debug_st, _fmt, _args)
...
#define debug_lib(_fmt, _args...)       jdlogger(dlogger, __ak_debug_lib, _fmt, ##_args)
...
#define debug_st(_fmt, _args...)        jdlogger(dlogger, __ak_debug_st, _fmt, ##_args)
