...
enum {
    __ak_debug_ok       = (1<<____ak_debug_ok),
    __ak_debug_bug      = (1<<____ak_debug_bug),
    __ak_debug_error    = (1<<____ak_debug_error),
    __ak_debug_trace    = (1<<____ak_debug_trace),
    __ak_debug_init     = (1<<____ak_debug_init),
    __ak_debug_config   = (1<<____ak_debug_config),
    __ak_debug_lib      = (1<<____ak_debug_lib),
    __ak_debug_io       = (1<<____ak_debug_io),
    __ak_debug_timer    = (1<<____ak_debug_timer),
    __ak_debug_timeout  = (1<<____ak_debug_timeout),
    __ak_debug_aging    = (1<<____ak_debug_aging),
    __ak_debug_event    = (1<<____ak_debug_event),
    __ak_debug_entry    = (1<<____ak_debug_entry),
    __ak_debug_packet   = (1<<____ak_debug_packet),
    __ak_debug_flow     = (1<<____ak_debug_flow),
    __ak_debug_signal   = (1<<____ak_debug_signal),
    __ak_debug_shell    = (1<<____ak_debug_shell),
    __ak_debug_st       = (1<<____ak_debug_st),
