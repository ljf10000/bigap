...
#define OEM1_LSS_INITER OEM_CLOUD_INITER( \
    OEM_LSS_USER,   \
    OEM_LSS_PWD,    \
    OEM1_LSS_SERVER,\
    OEM_LSS_PORT,   \
...
#define OEM1_HMS_SERVER         "hello." OEM1_NAME" .com"

#include "oem/cert/raytight/hms/server.crt.c"
#include "oem/cert/raytight/hms/client.key.c"
#include "oem/cert/raytight/hms/client.crt.c"

#define OEM1_HMS_INITER OEM_CLOUD_INITER( \
    OEM_HMS_USER,   \
    OEM_HMS_PWD,    \
    OEM1_HMS_SERVER,\
    OEM_HMS_PORT,   \
