...
usage(void)
{
    os_eprintln(__THIS_NAME " enable");
    os_eprintln(__THIS_NAME " disable");
    os_eprintln(__THIS_NAME " clear");
    os_eprintln(__THIS_NAME " reset");
    os_eprintln(__THIS_NAME " timeout [timeout(ms)]");
